...
#define EVENT_TYPE_LIST \
    ...
    EVENT_TYPE_ENTRY(MANAGED_SPACES_RECONCILE) \
    EVENT_TYPE_ENTRY(MANAGED_SPACE_TOPOLOGY_STEP) \
    EVENT_TYPE_ENTRY(MANAGED_SPACE_TOPOLOGY_WATCHDOG) \
    EVENT_TYPE_ENTRY(MANAGED_SPACE_TOPOLOGY_USER_INPUT) \
