//
// The primary scripting-addition provider is intentionally a transparent
// adapter. Validation, call ordering, return values, timing, and future
// improvements belong to the authoritative synchronous space_manager
// implementation.
//
