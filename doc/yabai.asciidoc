...
SPACE_SEL   := prev | next | next_fullscreen | prev_fullscreen | first | last | recent | mouse | <mission-control index (1-based)> | LABEL
...
*managed_space_names* ['<comma-separated names>']::
    ...
    applied as ordinary yabai space labels for selectors and rules. +
