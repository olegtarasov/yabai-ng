#ifndef MANAGED_SPACE_SIP_SAFE_H
#define MANAGED_SPACE_SIP_SAFE_H

enum managed_space_sip_safe_policy
{
    MANAGED_SPACE_SIP_SAFE_POLICY_AUTO,
    MANAGED_SPACE_SIP_SAFE_POLICY_BRIDGE,
    MANAGED_SPACE_SIP_SAFE_POLICY_ACCESSIBILITY
};

enum managed_space_sip_safe_backend
{
...
enum managed_space_sip_safe_state
{
    MANAGED_SPACE_SIP_SAFE_STATE_IDLE,
    MANAGED_SPACE_SIP_SAFE_STATE_QUEUED,
    ...
    MANAGED_SPACE_SIP_SAFE_STATE_WAITING_FOR_EVENT,
    MANAGED_SPACE_SIP_SAFE_STATE_WAITING_FOR_SETTLE,
    MANAGED_SPACE_SIP_SAFE_STATE_WAITING_FOR_MISSION_CONTROL_EXIT,
    MANAGED_SPACE_SIP_SAFE_STATE_FAILED
};
...
struct managed_space_sip_safe_request
{
    ...
    enum managed_space_sip_safe_backend backend;
    uint64_t generation;
...
struct managed_space_sip_safe
{
    ...
    enum managed_space_sip_safe_state state;
    struct managed_space_sip_safe_request current;
    struct managed_space_sip_safe_request *queue;
    ...
    enum managed_space_sip_safe_backend last_failed_backend;
};
...
struct managed_space_topology_result managed_space_sip_safe_create(struct managed_space_sip_safe *topology,
                                                                   enum managed_space_topology_origin origin,
                                                                   uint64_t acting_sid);
struct managed_space_topology_result managed_space_sip_safe_destroy_space(struct managed_space_sip_safe *topology,
                                                                          enum managed_space_topology_origin origin,
                                                                          uint64_t sid);
struct managed_space_topology_result managed_space_sip_safe_move_space(struct managed_space_sip_safe *topology,
                                                                       enum managed_space_topology_origin origin,
                                                                       uint64_t sid,
                                                                       uint64_t target_sid);
struct managed_space_topology_result managed_space_sip_safe_swap_spaces(struct managed_space_sip_safe *topology,
                                                                        enum managed_space_topology_origin origin,
                                                                        uint64_t sid,
                                                                        uint64_t target_sid);
struct managed_space_topology_result managed_space_sip_safe_move_space_to_display(struct managed_space_sip_safe *topology,
                                                                                  enum managed_space_topology_origin origin,
                                                                                  uint64_t sid,
                                                                                  uint32_t did,
                                                                                  bool placeholder_required);
...
struct managed_space_topology_result managed_space_sip_safe_submit_request(struct managed_space_sip_safe *topology,
                                                                           struct managed_space_sip_safe_request request,
                                                                           enum managed_space_topology_origin origin);
