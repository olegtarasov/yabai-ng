...
#define SPACE_PROPERTY_LIST \
    ...
    SPACE_PROPERTY_ENTRY("managed-name",         SPACE_PROPERTY_MANAGED_NAME,  0x4000) \
    SPACE_PROPERTY_ENTRY("displayable-window-count", SPACE_PROPERTY_DISPLAYABLE_WINDOW_COUNT, 0x8000) \
    SPACE_PROPERTY_ENTRY("displayable-windows",  SPACE_PROPERTY_DISPLAYABLE_WINDOWS, 0x10000) \
    SPACE_PROPERTY_ENTRY("displayable-apps",     SPACE_PROPERTY_DISPLAYABLE_APPS, 0x20000) \
    SPACE_PROPERTY_ENTRY("stacks",               SPACE_PROPERTY_STACKS, 0x40000)
