...
*--switch* '<SPACE_SEL>'::
    ...
    'next_fullscreen' enters the fullscreen chain from a managed space and remembers that origin, then advances through fullscreen spaces. +
...
*managed_spaces_changed*::
    ...
    derived managed-space presentation state changed. +
...
*managed_space_focused*::
    Triggered when the active managed space changes. +
